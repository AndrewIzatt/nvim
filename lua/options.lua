...
opt.scrolloff = 999 -- keeps cursor in middle of screen
opt.virtualedit = "block" -- allows visual block mode to extend beyond characters in line

-- vim.opt.inccommand = "split" -- provides small preview window with %s

-- appearance
-- turn on termguicolors for nightfly/tokyonight colorscheme to work
